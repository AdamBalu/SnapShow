...
const apiKey = 'VfoUiXyiMX2BzVBqQ8eWI9JRjpRoN3qY';
...
// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
async function loadData(eventsJson: any) {
...
// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
async function updateInterpretToEvent(event: Event, interpreter: Interpreter) {
...
// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
async function updateGenreToEvent(event: Event, genre: Genre) {
...
// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
async function getVenueData(venueURL: string) {
...
// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
async function getAttractionData(attractionURL: string) {
